...
#  BINARY genesis add-genesis-account $KEY 10000000$DENOM,900test --keyring-backend $KEYRING --denom-metadata '{"display":"tok","base":"TOK","description":"TOK token","denom_units":[{"denom":"TOK","exponent":9}]}' --append
  BINARY genesis add-genesis-account $KEY 10000000$DENOM --keyring-backend $KEYRING --denom-metadata '{"display":"tok","base":"TOK","description":"TOK token","denom_units":[{"denom":"TOK","exponent":9}]}' --append
  BINARY genesis add-genesis-account $KEY2 10000000$DENOM --keyring-backend $KEYRING --denom-metadata '{"display":"tok","base":"TOK","description":"TOK token","denom_units":[{"denom":"TOK","exponent":9}]}' --append
