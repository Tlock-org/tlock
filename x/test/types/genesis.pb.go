...
func init() {
	proto.RegisterType((*GenesisState)(nil), "test.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "test.v1.Params")
}

func init() { proto.RegisterFile("test/v1/genesis.proto", fileDescriptor_b873a20abde33944) }
