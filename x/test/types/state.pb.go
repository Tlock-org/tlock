...
func init() {
	proto.RegisterType((*ExampleData)(nil), "test.v1.ExampleData")
}

func init() { proto.RegisterFile("test/v1/state.proto", fileDescriptor_a06572813783339b) }
