...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "test.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "test.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("test/v1/query.proto", fileDescriptor_b8295460cd91ceef) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/test.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test.v1.Query/Params",
	}
